...
import { getTransactionSize, TRANSACTION_SIZE_LIMIT, V1_TRANSACTION_SIZE_LIMIT } from './transaction-size';
...
export function getTransactionMessageSizeLimit(
    ...
    return transactionMessage.version === 1 ? V1_TRANSACTION_SIZE_LIMIT : TRANSACTION_SIZE_LIMIT;
}
